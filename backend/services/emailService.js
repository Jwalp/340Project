...
exports.sendVerificationEmail = async (email, verificationToken) => {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Email Verification - FileVerse',
      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2 style="color: #00ff88; margin-top: 0;">Welcome to FileVerse!</h2>
              <p>Hello,</p>
              <p>Thank you for signing up for FileVerse. To complete your registration, please verify your email address by clicking the button below:</p>
              <div style="text-align: center;">
                <a href="${verificationUrl}" class="btn">Verify Email Address</a>
              </div>
              <p>Or copy and paste this link into your browser:</p>
              <p style="word-break: break-all; color: #00ff88;">${verificationUrl}</p>
              <div class="warning">
                <strong>⚠️ Important:</strong> This link will expire in 24 hours. If you didn't create an account with FileVerse, please ignore this email.
              </div>
            </div>
            <div class="footer">
      ...
      `,
      text: `
        Welcome to FileVerse!
        
        Hello,
        
        Thank you for signing up for FileVerse. To complete your registration, please verify your email address by clicking the link below:
        
        ${verificationUrl}
        
        This link will expire in 24 hours.
        
        If you didn't create an account with FileVerse, please ignore this email.
